...
class LogisticRegressionModel(object):
    ...
    def multi_class_model(self):
        ...
        model = svm.LinearSVC(C=5, dual=False, max_iter=self.max_iter, penalty='l2')
        ...
        if self.store_submit is True:
            ...
            file_name = 'submit_svm' + time_string + '.csv'
            submit.to_csv(submit_file + file_name, index=None, encoding='utf-8')


if __name__ == '__main__':
    lr_model = LogisticRegressionModel(max_iter=1000, rows=-1, dimensions=1000, store_submit=True)
