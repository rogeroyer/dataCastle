...
# feature1 = pd.pivot_table(train_data, index='user_id', values='coupon_id', aggfunc=call_mode)
...
m = feature17['up'].max()
n = feature17['up'].min()
feature17['up'] = [(index-n)/(m-n) for index in feature17['up']]
# print feature17
...
feature18['down'] = [(index-n)/(m-n) for index in feature18['down']]
# print feature18
