...
set_one = set([7, 6])
feature11['eight'] = [1 if index in set_one else 0 for index in feature11['week']]
feature11['month'] = [index.day for index in test_dataset['date_received']]
# print feature11
...
test_dataset['feature11_nine'] = feature11['month']
...
test_dataset = test_dataset.merge(feature24, on='user_id', how='left')
